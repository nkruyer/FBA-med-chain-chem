...
function [model] = addRevBetaC8(input)
...
model = changeRxnBounds(input,{'ACACT1r','ECOAH1','ECOAH2','ECOAH3','HACD1i','HACD2i',...
'HACD3i','KAT2','KAT3'},[0 0 0 0 -999999 -999999 -999999 -999999 -999999],'l');
model = changeRxnBounds(model,{'HACD1i','HACD2i','HACD3i','KAT2','KAT3','ACOAD1f','ACOAD2f',...
...
%compounds
model = removeRxns(model,{'KAT1','KAT4','KAT5','KAT6','KAT7','ACACT8r'}); 
